 ...
 */
final class Version20190316220034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evolution ADD CONSTRAINT FK_420C28934D335D58 FOREIGN KEY (user_evolution_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE bug ADD CONSTRAINT FK_358CBF149F6FA8E8 FOREIGN KEY (user_bug_id) REFERENCES user_account (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
